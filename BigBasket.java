class BigBasket {
    ...
    public static String createAccount(String fullName, String email, String phoneNumber, String username, 
        ...
        if(isAccountValid) {
            ref = "BigBasket account created successfully!";
        } else {
    ...
    public static boolean validateAccountDetails(String fullName, String email, String phoneNumber, 
        ...
        // Validate payment method (can be 'Credit Card', 'Debit Card', 'Net Banking', or 'Cash on Delivery')
        if(paymentMethod != null ) {
            isPaymentMethod = true;
            System.out.println("Payment method is valid.");
        } else {
            System.out.println("Payment method must be one of the following: 'Credit Card', 'Debit Card', 'Net Banking', or 'Cash on Delivery'.");
        }
