class RedBus {
    ...
    public static String accountCreation(String fullName, String email, String phoneNumber, String username,
                                       String password, String confirmPassword, String address, String city,
                                       String pincode, String preferredPaymentMethod) {
        String ref = null;

        boolean isAccountValid = validateAccountDetails(fullName, email, phoneNumber, username, password, 
                                                        confirmPassword, address, city, pincode, preferredPaymentMethod);

        if(isAccountValid) {
            ref = "RedBus account created successfully!";
        } else {
    ...
    public static boolean validateAccountDetails(String fullName, String email, String phoneNumber, 
                                                 ...
                                                 String address, String city, String pincode, String preferredPaymentMethod) {
        ...
        boolean isPreferredPaymentMethod = false;
        ...
        // Validate preferred payment method (can be 'Cash' or 'Online')
        if(preferredPaymentMethod != null ) {
            isPreferredPaymentMethod = true;
            System.out.println("Preferred Payment Method is valid.");
        } else {
            System.out.println("Preferred Payment Method must be 'Cash' or 'Online'.");
        }

        // Final validation: All conditions must be true
        if(isFullName && isEmail && isPhoneNumber && isUsername && isPassword && isConfirmPassword && 
           isAddress && isCity && isPincode && isPreferredPaymentMethod) {
            isValid = true;
        }
